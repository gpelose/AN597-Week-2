...
#NK: adding ```{r} in the line before your code & ``` in the line following your code makes a nice output format on your R markdown file
```
...
str_extract(v, "and")
str_extract(v, "lay")
#NK: I feel like there's an easier way to do this, but I struggled too so I don't want to give advice here
```
