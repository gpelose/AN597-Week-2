---
title: "nicfall_PeerCommentary_gpelose_01"
author: "Greg Pelose"
date: "9/11/2019"
...
```{r}
library("stringr") #NK: added a line of code to load your stringr library
#NK: adding ```{r} in the line before your code & ``` in the line following your code makes a nice output format on your R markdown file - you'll see I did this a lot in the rest of the document. Hit "knit" with the knitting needles above in R studio & you get to see what your whole document looks like when you're done
```
...
str_extract(v, "and")
str_extract(v, "lay")
#NK: this output looks a little off and I feel like there's an easier way to do this, but I struggled too so I don't want to give advice here, sorry :/. Feel free to take a look at my code solution though. 
```
...
#NK: nice job, but R markdown does the output automatically if you do the ``` thing I mentioned in the beginning :)
```
...
list(r)
list(c(s,t,u,v,w))
#NK: see my code! Not an easy one. 
```
...
#NK: you don't need this line above, since you make the matrix in the next line, but it's awesome that you showed your thought process
...
#NK: adding the output here, nice job!
str(M1data)
```
...
```{r}
#NK: in your original code, the default R markdown example text was here, I removed it :)
```